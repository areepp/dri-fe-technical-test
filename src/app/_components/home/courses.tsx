...
export function Courses() {
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[1110px] px-6 pb-20 md:px-10 lg:px-0 lg:pb-28">
      <div className="grid gap-14 sm:grid-cols-2 sm:gap-x-[30px] sm:gap-y-[50px] lg:grid-cols-3 lg:gap-x-[30px] lg:gap-y-[78px] lg:pt-16">
        <div className="rounded-2xl bg-gradient-to-b from-gradient-orange to-gradient-pink p-8 sm:col-span-2 lg:col-span-1">
